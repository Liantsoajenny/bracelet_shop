    ...
    <div>
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className={`max-w-2xl transition-opacity duration-1000 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-100 max-w-xl drop-shadow">
              Vente et valorisation des produits artisanaux malgaches
            </p>
            {/* Boutons ici */}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">Nos Collections</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative rounded-lg overflow-hidden group h-80 shadow-md">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/10 flex flex-col justify-end p-6 text-white">
                <h3 className="font-heading text-2xl font-bold mb-2 drop-shadow-md">Bracelets Brésiliens</h3>
                <p className="mb-4 text-gray-200 drop-shadow">Faits main avec amour et tradition</p>
            ...
            <div className="relative rounded-lg overflow-hidden group h-80 shadow-md">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/10 flex flex-col justify-end p-6 text-white">
                <h3 className="font-heading text-2xl font-bold mb-2 drop-shadow-md">Arts Malgaches</h3>
                <p className="mb-4 text-gray-200 drop-shadow">Trésors culturels de Madagascar</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-8">
            <h2 className="font-heading text-3xl font-bold">Produits en vedette</h2>
